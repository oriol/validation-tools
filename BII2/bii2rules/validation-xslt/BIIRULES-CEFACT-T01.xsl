...
<xsl:template match="/" mode="generate-id-2">U</xsl:template>
   ...
   <!--SCHEMA METADATA-->
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="BIIRULES  T01 bound to CEFACT"
                              schemaVersion="">
         <xsl:comment>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">BIIRULES  T01 bound to CEFACT</svrl:text>
   ...
   <!--PATTERN CEFACT-T01-->
	...
	<!--RULE -->
<xsl:template match="//ram:SpecifiedCITradeAllowanceCharge" priority="1006" mode="M6">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//ram:SpecifiedCIOHTradeSettlementMonetarySummation" priority="1004"
                 mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//ram:IncludedCIOLSupplyChainTradeLineItem" priority="1001" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
