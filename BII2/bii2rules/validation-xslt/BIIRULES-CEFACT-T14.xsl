...
<xsl:template match="/" mode="generate-id-2">U</xsl:template>
   ...
   <!--SCHEMA METADATA-->
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="BIIRULES  T14 bound to CEFACT"
                              schemaVersion="">
         <xsl:comment>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">CEFACT-T14</xsl:attribute>
            <xsl:attribute name="name">CEFACT-T14</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">CodesT14</xsl:attribute>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">BIIRULES  T14 bound to CEFACT</svrl:text>
   ...
   <!--PATTERN CEFACT-T14-->
	...
	<!--RULE -->
<xsl:template match="//ram:SpecifiedCITradeAllowanceCharge" priority="1005" mode="M6">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice" priority="1004" mode="M6">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//ram:IncludedCIILSupplyChainTradeLineItem" priority="1003" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="/rsm:CrossIndustryInvoice_Period_Information" priority="1002" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/rsm:CrossIndustryInvoice_Period_Information"/>
