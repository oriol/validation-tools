...
<!--SCHEMA METADATA-->
   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="BIIRULES  T19 bound to CEFACT" schemaVersion="">
         <axsl:comment>
         ...
         <svrl:active-pattern>
            <axsl:attribute name="id">CEFACT-T19</axsl:attribute>
            <axsl:attribute name="name">CEFACT-T19</axsl:attribute>
...
<!--SCHEMATRON PATTERNS-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">BIIRULES  T19 bound to CEFACT</svrl:text>
...
<!--PATTERN CEFACT-T19-->
   ...
   <axsl:template match="/rsm:CrossIndustryCatalogue" priority="1011" mode="M6">
   ...
   <axsl:template match="//ram:ProcurementCITradeParty" priority="1010" mode="M6">
   ...
   <axsl:template match="//ram:IncludedCICLSupplyChainTradeLineItem" priority="1009" mode="M6">
   ...
   <axsl:template match="//ram:CatalogueInformationProviderCITradeParty" priority="1008" mode="M6">
   ...
   <axsl:template match="//ram:CatalogueInformationReceiverCITradeParty" priority="1007" mode="M6">
   ...
   <axsl:template match="//ram:SellerCITradeParty" priority="1006" mode="M6">
   ...
   <axsl:template match="//ram:SpecifiedCatalogueTradeProduct" priority="1005" mode="M6">
...
- Standard identifier</svrl:text>
   ...
   <axsl:template match="//ram:SpecifiedCatalogueTradeProduct_Commodity" priority="1004" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//ram:SpecifiedCatalogueTradeProduct_Commodity"/>
   ...
   <axsl:template match="//ram:NetPriceProductCITradePrice" priority="1003" mode="M6">
   ...
   <axsl:template match="//ram:ApplicableCIProductCharacteristic" priority="1002" mode="M6">
   ...
   <axsl:template match="//ram:SpecifiedCatalogueTradeProduct_Standard" priority="1001" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//ram:SpecifiedCatalogueTradeProduct_Standard"/>
