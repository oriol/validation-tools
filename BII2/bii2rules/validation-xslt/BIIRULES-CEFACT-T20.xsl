...
<xsl:template match="/" mode="generate-id-2">U</xsl:template>
   ...
   <!--SCHEMA METADATA-->
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="BIIRULES  T20 bound to CEFACT"
                              schemaVersion="">
         <xsl:comment>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">CEFACT-T20</xsl:attribute>
            <xsl:attribute name="name">CEFACT-T20</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">BIIRULES  T20 bound to CEFACT</svrl:text>
   ...
   <!--PATTERN CEFACT-T20-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryCatalogue" priority="1008" mode="M6">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//ram:IncludedCICLSupplyChainTradeLineItem" priority="1006" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//ram:CatalogueInformationProviderCITradeParty" priority="1005"
                 mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//ram:CatalogueInformationReceiverCITradeParty" priority="1004"
                 mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//ram:SellerCITradeParty" priority="1003" mode="M6">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//ram:SpecifiedCatalogueTradeProduct" priority="1002" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
