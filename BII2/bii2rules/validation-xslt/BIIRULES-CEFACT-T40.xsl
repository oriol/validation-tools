...
<xsl:stylesheet xmlns:xsd="http://www.w3.org/2001/XMLSchema"
                ...
                xmlns:rsm="urn:un:unece:uncefact:ata:standard:InvitationToTender:8"
...
<xsl:template match="/" mode="generate-id-2">U</xsl:template>
   ...
   <!--SCHEMA METADATA-->
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="BIIRULES  T40 bound to CEFACT"
                              schemaVersion="">
         <xsl:comment>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">CEFACT-T40</xsl:attribute>
            <xsl:attribute name="name">CEFACT-T40</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">BIIRULES  T40 bound to CEFACT</svrl:text>
   ...
   <!--PATTERN CEFACT-T40-->
	...
	<!--RULE -->
<xsl:template match="/rsm:InvitationToTender" priority="1003" mode="M6">
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="//ram:TenderInvitationDocument/ram:ID"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="//ram:TenderInvitationDocument/ram:ID">
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(ram:TenderTenderingProcess)"/>
         <xsl:otherwise>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(ram:ProcuringProject/ram:Description)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(ram:ProcuringProject/ram:Description)">
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(ram:ProcuringProject/ram:PhysicalProjectActualizationLocation)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(ram:ProcuringProject/ram:PhysicalProjectActualizationLocation)">
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(ram:ProcuringProject/ram:PlanTenderingPeriod)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(ram:ProcuringProject/ram:PlanTenderingPeriod)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(//ram:TenderTenderingProcess/ram:AcceptanceTenderingPeriod/ram:EndDateTime)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(//ram:TenderTenderingProcess/ram:AcceptanceTenderingPeriod/ram:EndDateTime)">
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(ram:TenderTenderingProcess/ram:JudgingCriteriaCode)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(ram:TenderTenderingProcess/ram:JudgingCriteriaCode)">
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(//ram:TenderingProcedureCode)"/>
         <xsl:otherwise>
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//ram:ProcuringProject" priority="1001" mode="M6">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//ram:TenderBillOfQuantities" priority="1000" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="//ram:TenderBillOfQuantities"/>
