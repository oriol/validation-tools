...
<xsl:stylesheet xmlns:xsd="http://www.w3.org/2001/XMLSchema"
                ...
                xmlns:rsm="urn:un:unece:uncefact:data:standard:Tender:8"
...
<xsl:template match="/" mode="generate-id-2">U</xsl:template>
   ...
   <!--SCHEMA METADATA-->
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="BIIRULES  T44 bound to CEFACT"
                              schemaVersion="">
         <xsl:comment>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">CEFACT-T44</xsl:attribute>
            <xsl:attribute name="name">CEFACT-T44</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">CodesT44</xsl:attribute>
            <xsl:attribute name="name">CodesT44</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">BIIRULES  T44 bound to CEFACT</svrl:text>
   ...
   <!--PATTERN CEFACT-T44-->
	...
	<!--RULE -->
<xsl:template match="/rsm:Tender" priority="1006" mode="M6">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="false()">
               <xsl:attribute name="id">BII2-T44-R001</xsl:attribute>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="false()">
               <xsl:attribute name="id">BII2-T44-R002</xsl:attribute>
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="false()">
               <xsl:attribute name="id">BII2-T44-R004</xsl:attribute>
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="false()">
               <xsl:attribute name="id">BII2-T44-R005</xsl:attribute>
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="false()">
               <xsl:attribute name="id">BII2-T44-R006</xsl:attribute>
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//ram:ProcuringOrganization" priority="1005" mode="M6">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(ram:Name) or (ram:ID)">
               <xsl:attribute name="id">BII2-T44-R008</xsl:attribute>
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
	  ...
	  <!--RULE -->
<xsl:template match="/rsm:Tender" priority="1004" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/rsm:Tender"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(ram:TendererOrganization)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(ram:TendererOrganization)">
               <xsl:attribute name="id">BII2-T44-R010</xsl:attribute>
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
	  ...
	  <!--RULE -->
<xsl:template match="//ram:TendererOrganization" priority="1003" mode="M6">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(ram:Name) or (ram:ID)">
               <xsl:attribute name="id">BII2-T44-R011</xsl:attribute>
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="/rsm:Tender" priority="1001" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/rsm:Tender"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="false()">
               <xsl:attribute name="id">BII2-T44-R014</xsl:attribute>
               <xsl:attribute name="flag">warning</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
	  ...
	  <!--RULE -->
<xsl:template match="/rsm:Tender" priority="1000" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/rsm:Tender"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="//ram:ProcuringProject/ram:TotalBudgetAmount"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="//ram:ProcuringProject/ram:TotalBudgetAmount">
               <xsl:attribute name="id">BII2-T44-R015</xsl:attribute>
               <xsl:attribute name="flag">fatal</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--PATTERN CodesT44-->
	...
	<!--RULE -->
<xsl:template match="@mimeCode" priority="1000" mode="M7">
