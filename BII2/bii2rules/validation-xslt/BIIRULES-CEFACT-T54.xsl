...
<xsl:template match="/" mode="generate-id-2">U</xsl:template>
   ...
   <!--SCHEMA METADATA-->
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="BIIRULES  T54 bound to CEFACT"
                              schemaVersion="">
         <xsl:comment>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">CEFACT-T54</xsl:attribute>
            <xsl:attribute name="name">CEFACT-T54</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">BIIRULES  T54 bound to CEFACT</svrl:text>
   ...
   <!--PATTERN CEFACT-T54-->
	...
	<!--RULE -->
<xsl:template match="/rsm:CrossIndustryCatalogue" priority="1010" mode="M6">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//ram:ProcurementCITradeParty" priority="1009" mode="M6">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//ram:IncludedCICLSupplyChainTradeLineItem" priority="1008" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="number(ram:SpecifiedCICLSupplyChainTradeAgreement/ram:OrderProductUnitMeasureCode) &gt;= 0"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="number(ram:SpecifiedCICLSupplyChainTradeAgreement/ram:OrderProductUnitMeasureCode) &gt;= 0">
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="number(//ram:MaximumProductOrderableQuantity) &gt;= 0"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="number(//ram:MaximumProductOrderableQuantity) &gt;= 0">
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="number(//ram:MinimumProductOrderableQuantity) &gt;= 0"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="number(//ram:MinimumProductOrderableQuantity) &gt;= 0">
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="number(//ram:MaximumProductOrderableQuantity) &gt;= number(//ram:MinimumProductOrderableQuantity)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="number(//ram:MaximumProductOrderableQuantity) &gt;= number(//ram:MinimumProductOrderableQuantity)">
	  ...
	  <!--RULE -->
<xsl:template match="//ram:CatalogueInformationProviderCITradeParty" priority="1007"
                 mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//ram:CatalogueInformationReceiverCITradeParty" priority="1006"
                 mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//ram:SellerCITradeParty" priority="1005" mode="M6">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//ram:SellerCITradeParty/ram:PostalCITradeAddress" priority="1004"
                 mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="//ram:SellerCITradeParty/ram:PostalCITradeAddress"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(ram:LineOne) and (ram:CityName) and (ram:PostcodeCode) and (ram:CountryID)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(ram:LineOne) and (ram:CityName) and (ram:PostcodeCode) and (ram:CountryID)">
...
- Country code</svrl:text>
	  ...
	  <!--RULE -->
<xsl:template match="//ram:SpecifiedCatalogueTradeProduct" priority="1003" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="//ram:SpecifiedCatalogueTradeProduct"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(ram:GlobalID) or (ram:SellerAssignedID)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(ram:GlobalID) or (ram:SellerAssignedID)">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//ram:NetPriceProductCITradePrice" priority="1002" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//ram:ApplicableCIProductCharacteristic" priority="1001" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="//ram:ApplicableCIProductCharacteristic"/>
...
<xsl:choose>
   ...
   <!--PATTERN CodesT54-->
	...
	<!--RULE -->
<xsl:template match="ram:LineStatusCode" priority="1002" mode="M7">
