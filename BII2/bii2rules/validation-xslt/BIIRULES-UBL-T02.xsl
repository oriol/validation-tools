...
<!--PATTERN UBL-T02-->
   ...
   <axsl:template match="/ubl:OrderResponseSimple" priority="1001" mode="M5">
      ...
      <axsl:choose>
         <axsl:when test="(cbc:AcceptedIndicator = true) and not(cbc:Note)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(cbc:AcceptedIndicator = true) and not(cbc:Note)">
