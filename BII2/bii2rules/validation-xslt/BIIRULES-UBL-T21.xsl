...
<xsl:stylesheet xmlns:xsd="http://www.w3.org/2001/XMLSchema"
                ...
                xmlns:ubl="urn:oasis:names:specification:ubl:schema:xsd:CataloguePriceUpdate-2"
...
<xsl:template match="/" mode="generate-id-2">U</xsl:template>
   ...
   <!--SCHEMA METADATA-->
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="BIIRULES  T21 bound to UBL"
                              schemaVersion="">
         <xsl:comment>
         ...
         <svrl:ns-prefix-in-attribute-values uri="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2"
                                             prefix="cac"/>
         <svrl:ns-prefix-in-attribute-values uri="urn:oasis:names:specification:ubl:schema:xsd:CataloguePriceUpdate-2"
                                             prefix="ubl"/>
         <svrl:active-pattern>
            <xsl:attribute name="document">
               <xsl:value-of select="document-uri(/)"/>
            </xsl:attribute>
            <xsl:attribute name="id">UBL-T21</xsl:attribute>
            <xsl:attribute name="name">UBL-T21</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="/ubl:CataloguePriceUpdate" priority="1006" mode="M6">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//cac:CatalogueLine" priority="1005" mode="M6">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//cac:ProviderParty" priority="1004" mode="M6">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//cac:ReceiverParty" priority="1003" mode="M6">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//cac:SellerSupplierParty" priority="1002" mode="M6">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//cac:RequiredItemLocationQuantity/cac:Price" priority="1001" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
...
<xsl:choose>
   ...
   <!--PATTERN CodesT21-->
	...
	<!--RULE -->
<xsl:template match="cac:CatalogueLine//cbc:ActionCode" priority="1000" mode="M7">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
