...
<!--SCHEMA METADATA-->
   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="BIIRULES  T41 bound to UBL" schemaVersion="">

         <svrl:ns-prefix-in-attribute-values uri="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" prefix="cbc"/>
         <svrl:ns-prefix-in-attribute-values uri="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" prefix="cac"/>
         <svrl:ns-prefix-in-attribute-values uri="urn:oasis:names:specification:ubl:schema:xsd:TendererQualification-2" prefix="ubl"/>
         <svrl:active-pattern>
            <axsl:attribute name="id">UBL-T41</axsl:attribute>
            <axsl:attribute name="name">UBL-T41</axsl:attribute>
...
<!--PATTERN UBL-T41-->
   ...
   <axsl:template match="//cac:TendererPartyQualification" priority="1001" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//cac:TendererPartyQualification"/>

		<!--ASSERT -->

      <axsl:choose>
         <axsl:when test="(cac:MainQualifyingParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName) and ((cac:AdditionalQualifyingParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName)or not(cac:AdditionalQualifyingParty))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(cac:MainQualifyingParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName) and ((cac:AdditionalQualifyingParty/cac:Party/cac:PartyLegalEntity/cbc:RegistrationName)or not(cac:AdditionalQualifyingParty))">
      ...
      <axsl:choose>
         <axsl:when test="(cac:MainQualifyingParty/cac:Party/cac:Person/cbc:FamilyName) or not((cac:MainQualifyingParty/cac:Party/cac:Person))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(cac:MainQualifyingParty/cac:Party/cac:Person/cbc:FamilyName) or not((cac:MainQualifyingParty/cac:Party/cac:Person))">
   ...
   <axsl:template match="/ubl:TendererQualification" priority="1000" mode="M6">
      ...
      <axsl:choose>
         <axsl:when test="(cac:TendererPartyQualification/cac:MainQualifyingParty)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(cac:TendererPartyQualification/cac:MainQualifyingParty)">
