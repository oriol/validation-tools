...
<!--SCHEMA METADATA-->
   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="BIIRULES  T54 bound to UBL" schemaVersion="">
         ...
         <svrl:active-pattern>
            <axsl:attribute name="id">UBL-T54</axsl:attribute>
            <axsl:attribute name="name">UBL-T54</axsl:attribute>
...
<!--PATTERN UBL-T54-->
   ...
   <axsl:template match="//cac:CatalogueLine" priority="1008" mode="M6">
      ...
      <axsl:choose>
         ...
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(//cac:UsabilityPeriod/cbc:StartDate and //cac:UsabilityPeriod/cbc:EndDate) and (number(translate(//cac:UsabilityPeriod/cbc:StartDate,'-','')) &gt;= number(translate(//cac:LineValidityPeriod/cbc:StartDate,'-',''))) and (number(translate(//cac:UsabilityPeriod/cbc:EndDate,'-','')) &lt;= number(translate(//cac:LineValidityPeriod/cbc:EndDate,'-','')))">
