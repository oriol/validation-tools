...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="BIIRULES  T10 bound to CEFACT"
                              schemaVersion="">
         <xsl:comment>
         ...
         <svrl:ns-prefix-in-attribute-values uri="urn:un:unece:uncefact:data:Standard:ReusableAggregateBusinessInformationEntity:10"
                                             prefix="ram"/>
         <svrl:ns-prefix-in-attribute-values uri="urn:un:unece:uncefact:data:standard:CrossIndustryInvoice:4"
                                             prefix="rsm"/>
         <svrl:active-pattern>
   ...
   <xsl:template match="/rsm:CrossIndustryInvoice" priority="1005" mode="M6">
	  ...
	  <!--RULE -->
   <xsl:template match="//ram:IncludedCIILSupplyChainTradeLineItem"
                 priority="1004"
                 mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <xsl:template match="//ram:BillingCISpecifiedPeriod" priority="1003" mode="M6">
	  ...
	  <!--RULE -->
   <xsl:template match="//ram:SpecifiedCITradeSettlementPaymentMeans"
                 priority="1002"
                 mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
	  ...
	  <!--RULE -->
   <xsl:template match="//ram:SpecifiedCIIHTradeSettlementMonetarySummation"
                 priority="1001"
                 mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
	  ...
	  <!--RULE -->
   <xsl:template match="//ram:SubtotalCalculatedCITradeTax"
                 priority="1000"
                 mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--PATTERN CodesT10-->
	  ...
	  <!--RULE -->
   <xsl:template match="ram:CIIHExchangedDocument//ram:TypeCode"
                 priority="1007"
                 mode="M7">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <xsl:template match="ram:CIIHSupplyChainTradeTransaction/ram:ApplicableCIIHSupplyChainTradeSettlement/ram:ApplicableCITradeTax//ram:TypeCode"
	  ...
	  <!--RULE -->
   <xsl:template match="ram:AttachedSpecifiedBinaryFile//ram:MIMECode"
                 priority="1001"
                 mode="M7">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
	  ...
	  <!--RULE -->
   <xsl:template match="ram:SpecifiedCITradeAllowanceCharge//ram:ReasonCode"
                 priority="1000"
                 mode="M7">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
