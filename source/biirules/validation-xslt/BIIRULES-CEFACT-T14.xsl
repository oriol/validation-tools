...
<!--SCHEMA SETUP-->
   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="BIIRULES  T14 bound to CEFACT" schemaVersion="">
         <axsl:comment>
         ...
         <svrl:active-pattern>
            <axsl:attribute name="id">CEFACT-T14</axsl:attribute>
            <axsl:attribute name="name">CEFACT-T14</axsl:attribute>
...
<!--SCHEMATRON PATTERNS-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">BIIRULES  T14 bound to CEFACT</svrl:text>
...
<!--PATTERN CEFACT-T14-->
   ...
   <axsl:template match="//ram:SpecifiedCITradeAllowanceCharge" priority="1005" mode="M6">
   ...
   <axsl:template match="/rsm:CrossIndustryInvoice" priority="1004" mode="M6">
   ...
   <axsl:template match="//ram:IncludedCIILSupplyChainTradeLineItem" priority="1003" mode="M6">
   ...
   <axsl:template match="/rsm:CrossIndustryInvoice_Period_Information" priority="1002" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/rsm:CrossIndustryInvoice_Period_Information"/>
