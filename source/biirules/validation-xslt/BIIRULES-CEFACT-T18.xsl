...
<xsl:template match="/" mode="generate-id-2">U</xsl:template>
   ...
   <!--SCHEMA METADATA-->
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="BIIRULES  T18 bound to CEFACT"
                              schemaVersion="">
         <xsl:comment>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">CEFACT-T18</xsl:attribute>
            <xsl:attribute name="name">CEFACT-T18</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//ram:SpecifiedCatalogueTradeProduct" priority="1001" mode="M5">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="/rsm:CrossIndustryCatalogue" priority="1000" mode="M5">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/rsm:CrossIndustryCatalogue"/>
