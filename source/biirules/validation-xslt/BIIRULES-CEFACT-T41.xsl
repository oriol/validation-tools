...
<xsl:stylesheet xmlns:xsd="http://www.w3.org/2001/XMLSchema"
                ...
                xmlns:rsm="urn:un:unece:uncefact:ata:standard:QualificationApplication:8"
...
<xsl:template match="/" mode="generate-id-2">U</xsl:template>
   ...
   <!--SCHEMA METADATA-->
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="BIIRULES  T41 bound to CEFACT"
                              schemaVersion="">
         <xsl:comment>
         ...
         <svrl:ns-prefix-in-attribute-values uri="urn:un:unece:uncefact:data:Standard:ReusableAggregateBusinessInformationEntity:10"
                                             prefix="ram"/>
         <svrl:ns-prefix-in-attribute-values uri="urn:un:unece:uncefact:ata:standard:QualificationApplication:8"
                                             prefix="rsm"/>
         <svrl:active-pattern>
            <xsl:attribute name="document">
               <xsl:value-of select="document-uri(/)"/>
            </xsl:attribute>
            <xsl:attribute name="id">CEFACT-T41</xsl:attribute>
            <xsl:attribute name="name">CEFACT-T41</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">BIIRULES  T41 bound to CEFACT</svrl:text>
   ...
   <!--PATTERN CEFACT-T41-->
	...
	<!--RULE -->
<xsl:template match="//ram:ProcuringOrganization" priority="1002" mode="M6">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//ram:TendererOrganization" priority="1001" mode="M6">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="/rsm:QualificationApplication" priority="1000" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="/rsm:QualificationApplication"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(ram:QualificationApplicationDocument/ram:ID)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(ram:QualificationApplicationDocument/ram:ID)">
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(ram:QualificationApplicationDocument/ram:SubmissionDateTime)"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="(ram:QualificationApplicationDocument/ram:SubmissionDateTime)">
