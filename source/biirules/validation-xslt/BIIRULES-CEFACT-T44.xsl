...
<!--SCHEMA METADATA-->
   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="BIIRULES  T44 bound to CEFACT" schemaVersion="">
         <axsl:comment>
         ...
         <svrl:active-pattern>
            <axsl:attribute name="id">CEFACT-T44</axsl:attribute>
            <axsl:attribute name="name">CEFACT-T44</axsl:attribute>
...
<!--SCHEMATRON PATTERNS-->
   ...
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">BIIRULES  T44 bound to CEFACT</svrl:text>
...
<!--PATTERN CEFACT-T44-->
   ...
   <axsl:template match="/rsm:Tender" priority="1006" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/rsm:Tender"/>
      ...
      <axsl:choose>
         <axsl:when test="(ram:TenderDocument/ram:ID)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(ram:TenderDocument/ram:ID)">
   ...
   <axsl:template match="//ram:ProcuringOrganization" priority="1005" mode="M6">
   ...
   <axsl:template match="/rsm:Tender" priority="1004" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/rsm:Tender"/>
   ...
   <axsl:template match="//ram:TendererOrganization" priority="1003" mode="M6">
   ...
   <axsl:template match="//ram:TenderingDeliverable" priority="1002" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//ram:TenderingDeliverable"/>

		<!--ASSERT -->

      <axsl:choose>
         <axsl:when test="(ram:SpecificationReference)"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(ram:SpecificationReference)">
   ...
   <axsl:template match="/rsm:Tender" priority="1001" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/rsm:Tender"/>
   ...
   <axsl:template match="/rsm:Tender" priority="1000" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/rsm:Tender"/>

		<!--ASSERT -->

      <axsl:choose>
         <axsl:when test="//ram:ProcuringProject/ram:TotalBudgetAmount"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//ram:ProcuringProject/ram:TotalBudgetAmount">
