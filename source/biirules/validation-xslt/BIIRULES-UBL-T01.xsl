...
<!--PATTERN UBL-T01-->
   ...
   <axsl:template match="//cac:OrderLine" priority="1001" mode="M6">
      ...
      <axsl:choose>
         <axsl:when test="((cac:LineItem/cac:Price/cbc:PriceAmount) &gt;= 0) or (not(cac:LineItem/cac:Price))"/>
         <axsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="((cac:LineItem/cac:Price/cbc:PriceAmount) &gt;= 0) or (not(cac:LineItem/cac:Price))">
