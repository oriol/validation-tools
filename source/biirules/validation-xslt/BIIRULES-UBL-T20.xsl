...
<!--SCHEMA METADATA-->
   ...
   <axsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="BIIRULES  T20 bound to UBL" schemaVersion="">

         <svrl:ns-prefix-in-attribute-values uri="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" prefix="cbc"/>
         <svrl:ns-prefix-in-attribute-values uri="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" prefix="cac"/>
         <svrl:ns-prefix-in-attribute-values uri="urn:oasis:names:specification:ubl:schema:xsd:CatalogueItemSpecificationUpdate-2" prefix="ubl"/>
         <svrl:active-pattern>
            <axsl:attribute name="id">UBL-T20</axsl:attribute>
            <axsl:attribute name="name">UBL-T20</axsl:attribute>
...
<!--PATTERN UBL-T20-->
   ...
   <axsl:template match="/ubl:CatalogueItemSpecificationUpdate" priority="1008" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/ubl:CatalogueItemSpecificationUpdate"/>
   ...
   <axsl:template match="//cac:CatalogueLine" priority="1006" mode="M6">
   ...
   <axsl:template match="//cac:ProviderParty" priority="1005" mode="M6">
   ...
   <axsl:template match="//cac:ReceiverParty" priority="1004" mode="M6">
   ...
   <axsl:template match="//cac:SellerSupplierParty" priority="1003" mode="M6">
   ...
   <axsl:template match="//cac:Item" priority="1002" mode="M6">
