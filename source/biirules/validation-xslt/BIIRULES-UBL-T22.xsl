...
<xsl:stylesheet xmlns:xsd="http://www.w3.org/2001/XMLSchema"
                ...
                xmlns:ubl="urn:oasis:names:specification:ubl:schema:xsd:CatalogueDeletion-2"
...
<xsl:template match="/" mode="generate-id-2">U</xsl:template>
   ...
   <!--SCHEMA METADATA-->
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="BIIRULES  T22 bound to UBL"
                              schemaVersion="">
         <xsl:comment>
         ...
         <svrl:ns-prefix-in-attribute-values uri="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2"
                                             prefix="cac"/>
         <svrl:ns-prefix-in-attribute-values uri="urn:oasis:names:specification:ubl:schema:xsd:CatalogueDeletion-2"
                                             prefix="ubl"/>
         <svrl:active-pattern>
            <xsl:attribute name="document">
               <xsl:value-of select="document-uri(/)"/>
            </xsl:attribute>
            <xsl:attribute name="id">UBL-T22</xsl:attribute>
            <xsl:attribute name="name">UBL-T22</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
