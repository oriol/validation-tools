...
<xsl:template match="/" mode="generate-id-2">U</xsl:template>
   ...
   <!--SCHEMA METADATA-->
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="BIIRULES  T44 bound to UBL"
                              schemaVersion="">
         <xsl:comment>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">UBL-T44</xsl:attribute>
            <xsl:attribute name="name">UBL-T44</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">BIIRULES  T44 bound to UBL</svrl:text>
   ...
   <!--PATTERN UBL-T44-->
	...
	<!--RULE -->
<xsl:template match="/ubl:Tender" priority="1006" mode="M6">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//cac:ContractingParty" priority="1005" mode="M6">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="/ubl:Tender" priority="1004" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/ubl:Tender"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(cac:TendererParty)"/>
         <xsl:otherwise>
	  ...
	  <!--RULE -->
<xsl:template match="//cac:TendererParty" priority="1003" mode="M6">
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="//cac:TenderedProject" priority="1002" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//cac:TenderedProject"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(cac:TenderLine/cbc:ID)"/>
         <xsl:otherwise>
	  ...
	  <!--RULE -->
<xsl:template match="//cac:AwardingCriteriaResponse" priority="1001" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="//cac:AwardingCriteriaResponse"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="(cac:AwardingCriteriaID)"/>
         <xsl:otherwise>
	  ...
	  <!--RULE -->
<xsl:template match="/ubl:Tender" priority="1000" mode="M6">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="/ubl:Tender"/>
