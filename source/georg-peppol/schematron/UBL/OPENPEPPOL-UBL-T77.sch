...
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" is-a="T77" id="UBL-T77">
  ...
  <param name="EUGEN-T77-R005" value="(cbc:IssueDate) &lt;= current-date()"/>
  <param name="EUGEN-T77-R006" value="(cac:ProviderParty/cac:Party/cbc:EndpointID)"/>
  <param name="EUGEN-T77-R007" value="(cac:ReceiverParty/cac:Party/cbc:EndpointID)"/>
  <param name="EUGEN-T77-R008" value="(cac:Price/cbc:PriceAmount/@unitCode) = (cac:DeliveryUnit/cbc:BatchQuantity/@unitCode)"/>
