...
<!-- Timestamp: 2016-12-12 22:10:42 +0100 -->
<pattern xmlns="http://purl.oclc.org/dsdl/schematron" abstract="true" id="T77">
  ...
  <rule context="$Make_business_rule">
    <assert test="$EUGEN-T77-R005" flag="fatal" id="EUGEN-T77-R005">[EUGEN-T77-R005]-IssueDate may not be later than today.</assert>
  </rule>
